  ...
  <div class="vx-navbar-wrapper navbar-full p-0">
    <vs-navbar class="navbar-custom navbar-skelton" :class="navbarClasses"  :style="navbarStyle" :color="navbarColor">
      ...
      <div class="navbar-bookmarks flex items-center">
        <router-link tag="div" to="/" class="bookmark-container">
          <feather-icon icon="HomeIcon" :svgClasses="['stoke-current text-warning', textColor]" class="cursor-pointer p-2"/>
        </router-link>
        <router-link tag="div" to="/analysis" class="bookmark-container">
          <feather-icon icon="ActivityIcon" class="cursor-pointer p-2"/>
        </router-link>
      </div>
